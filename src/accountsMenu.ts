  ...
  return `
        <nav class="accounts-menu">
          ...
          <div class="menu-dropdown" data-dropdown="pay-transfer">
            <button class="menu-item-button${isPayTransferActive ? " menu-item-button-active" : ""}" type="button" data-nav-trigger="pay-transfer" aria-haspopup="true" aria-expanded="false">Pay &amp; Transfer</button>
